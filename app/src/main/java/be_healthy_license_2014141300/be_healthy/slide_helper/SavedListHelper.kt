...
class SavedListHelper(dragDirs:Int, swipeDirs:Int, listener: OnSwipeListener): ListHelper(dragDirs, swipeDirs, listener) {

    override fun onSelectedChanged(viewHolder: RecyclerView.ViewHolder?, actionState:Int) {
        if (viewHolder != null) {
            val foregroundView = (viewHolder as SavedDiseaseAdapter.MyViewHolder).viewForeground
