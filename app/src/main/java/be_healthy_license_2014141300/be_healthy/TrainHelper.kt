...
class TrainHelper(var view:View){
    ...
    private val instructions=listOf("Сядьте в удобное положение,снимите очки и расположите экран немного дальше,чем при чтении. Наш комплекс упражнений состоит из пяти небольших заданий, которые займут у вас чуть больше пяти минут. Нажмите 'Старт', когда будете готовы.",
            "Сейчас, пока будет идти таймер, вам нужно моргать как можно чаще. Нажмите 'старт', когда будете готовы.", "",
            "Пока будет идти таймер, переводите взгляд с точки на экране на любой отдаленный предмет.(дерево, машина и т.п.) Постарайтесь сфокусировать взгляд. Затем снова посмотрите на точку. Нажмите 'старт', когда будете готовы.", "",
            "Пока будет идти таймер, держите телефон в вытянутой руке на уровне глаз. Медленно приближайте телефон, стараясь сфокусировать взгляд на зеленой точке. Затем так же медленно верните телефон в исходное положение. Нажмите 'старт', когда будете готовы.", "",
            "Следующие несколько успражнений Вам нужно внимательно следить взглядом за точкой. Нажмите 'старт', когда будете готовы.", "", "Потрите руки друг о друга,чтобы ощутимо их нагреть. " +
